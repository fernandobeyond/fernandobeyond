...
**[BowserSecurity — Visión por Computador para Detección de Peligro](https://github.com/fernandobeyond/BowserSecurity)**
Modelo YOLO desplegado en dispositivo de borde (Raspberry Pi) con múltiples cámaras simultáneas, identificando amenazas con velocidad superior a la respuesta humana.
`Python` `YOLO` `OpenCV` `Raspberry Pi` `IoT`

**[Análisis y Visualización del Flujo de Neutrones](https://github.com/fernandobeyond/AnalisisVisualizacion_FlujoDeNeutrones)**
Modelado y visualización de datos de física nuclear aplicando métodos computacionales con Python — resultado de exposición académica.
`Python` `Data Visualization` `Física Computacional`

**[Artículo — Dynamic Spectrum Access para mitigación de interferencia WiFi](https://github.com/fernandobeyond/Articulo_DSA_WiFi)**
